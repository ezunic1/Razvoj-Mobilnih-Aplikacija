...
class TestS4 {
    ...
    //data
    var news1 = NewsItem(uuid=1.toString(), title = "Naslova T0", snippet = "snpt", category = "politics", imageUrl = "", isFeatured = true, publishedDate = "01-01-2025", source = "izvor")
    var news2 = NewsItem(uuid=2.toString(), title = "Naslova 2", snippet = "snpt 2", category = "sport", imageUrl = "", isFeatured = false, publishedDate = "01-02-2025", source = "izvor 2")
